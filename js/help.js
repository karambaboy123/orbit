...
const HELP_CONTENT={
  ...
  portfolio:{
    ...
    intro:'Beheer je leerdoelen per werkruimte, volg je groei over tijd, en draai een professioneel portfolio of ontwikkelplan (POP) uit als PDF.',
    steps:[
      {icon:'folderopen',text:'Werk met aparte werkruimtes (bijv. School, Werk, Stage) — wissel bovenaan tussen ze. Elke werkruimte heeft z\'n eigen leerdoelen, radar en eigen PDF-export.'},
      {icon:'add',      text:'Voeg een doel toe met een beschrijving, categorie en startniveau (1–100) via "Nieuw doel".'},
      {icon:'compass',  text:'"Nieuwe doelen ontdekken" — beantwoord ~20 AI-vragen en krijg automatisch passende leerdoelen voorgesteld.'},
      {icon:'analyse',  text:'"Groei analyseren" — laat je werk/verslagen door AI beoordelen volgens een strenge HBO-rubric (0–35 punten per leerdoel); accepteer of weiger de groei per doel.'},
      {icon:'chart',    text:'Werk je niveau bij naarmate je vordert — de groeigeschiedenis wordt bijgehouden (te annuleren via ↩) en verschijnt als groeiverloop-grafiek in de radar-sectie.'},
      {icon:'briefcase',text:'Voeg bij elk doel "Mijn werk" toe (tekst, link of verslag), en in "Bijlagen & links" algemene bestanden/links die niet bij één doel horen.'},
      {icon:'download', text:'"Portfolio uitdraaien" — een professionele PDF met voorpagina, inhoudsopgave, statistieken, vaardighedenradar, groeidiagram en je werk als kaarten, in je gekozen kleur.'},
      {icon:'clipboard',text:'"POP maken" — een Persoonlijk Ontwikkelingsplan als PDF: waar je nu staat, je focuspunten en een actieplan uit je openstaande mijlpalen (toekomstgericht).'},
      {icon:'trash',    text:'"Alle groei wissen" zet alle niveaus in deze werkruimte terug naar het startniveau en leegt de geschiedenis.'},
    ],
    tip:'Maak aparte werkruimtes voor school, werk en stage — elke werkruimte houdt z\'n eigen doelen bij en levert z\'n eigen PDF op.',
  },
  notes:{
