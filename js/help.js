...
const HELP_CONTENT={
  ...
  portfolio:{
    ...
    steps:[
      {icon:'add',     text:'Voeg een doel toe met een beschrijving en startniveau (1–100).'},
      {icon:'chart',   text:'Werk je niveau bij naarmate je vordert — de groeicurve wordt bijgehouden.'},
      {icon:'logbook', text:'Voeg logboekentries toe om vast te leggen wat je hebt geleerd.'},
    ],
